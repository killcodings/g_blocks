        ...
        <div class="cg-bookie-sect__cards">
            <div class="cg-bookie-container">
                <div class="cg-bookie" style="background: #681524;">
                    ...
                    <a href="#" class="cg-button cg-bookie__button" style="--button-bg: #FFF; --button-text-color: #D02E4B; --button-bg-hover: #F7F7F7;">
            ...
            <div class="cg-bookie-container">
                <div class="cg-bookie" style="background: #F7F7F7;">
                    ...
                    <a href="#" class="cg-button cg-bookie__button" style="--button-bg: #D02E4B; --button-text-color: #FFF; --button-bg-hover: #B42318;">
                        <span class="cg-button__text icon-arrow">Visit
                            Parimatch
                            Website
                        </span>
